...
def create_and_run_model():
    ...
    print(f"Memory after data creation: {memory_after_data - memory_after_model:.2f} MB")
    ...
    print(f"Memory after inference: {memory_after_inference - memory_after_data:.2f} MB")
...
def main():
    ...
    try:
        ...
        print("This is expected if running without memory_profiler or model imports fail")
