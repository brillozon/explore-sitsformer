...
class TestModelInferenceBenchmarks:
    ...
    def test_small_model_inference_speed(self, benchmark, small_model, sample_data_small):
    ...
    @pytest.mark.slow
    def test_large_model_inference_speed(self, benchmark, large_model, sample_data_large):
