...
class TestDataLoadingBenchmarks:
    ...
    def test_dataloader_small_batch(self, benchmark, sample_dataset_small):
        ...
        dataloader = DataLoader(sample_dataset_small, batch_size=8, shuffle=True, num_workers=0)
    ...
    def test_dataloader_large_batch(self, benchmark, sample_dataset_large):
        ...
        dataloader = DataLoader(sample_dataset_large, batch_size=32, shuffle=True, num_workers=0)
    ...
    def test_multiprocessing_loading(self, benchmark, sample_dataset_small):
        ...
        dataloader = DataLoader(sample_dataset_small, batch_size=8, shuffle=True, num_workers=2)
