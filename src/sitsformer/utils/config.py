...
SMALL_CONFIG = {
    ...
    "training": {"epochs": 20, "batch_size": 16, "learning_rate": 5e-4},
    "data": {"sequence_length": 5, "image_size": 64},
}
...
MEDIUM_CONFIG = {
    ...
    "training": {"epochs": 50, "batch_size": 16, "learning_rate": 1e-4},
    "data": {"sequence_length": 10, "image_size": 128},
}
...
LARGE_CONFIG = {
    ...
    "training": {"epochs": 200, "batch_size": 8, "learning_rate": 1e-4},
    "data": {"sequence_length": 20, "image_size": 256},
}
...
def get_preset_config(preset: str) -> Dict[str, Any]:
    ...
    Returns:
        Configuration dictionary
    """
    presets = {"small": SMALL_CONFIG, "medium": MEDIUM_CONFIG, "large": LARGE_CONFIG}
